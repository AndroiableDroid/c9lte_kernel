...
enum power_supply_type {
	...
	POWER_SUPPLY_TYPE_HV_MAINS,			/* Adaptive Charger (27) , AFC 1.0 15W: 9Vx1.67A */
	POWER_SUPPLY_TYPE_MDOCK_TA,			/* MMdock charger (28) */
	POWER_SUPPLY_TYPE_USB_PARALLEL,		/* USB Parallel Path (29) */
	POWER_SUPPLY_TYPE_HV_WIRELESS,		/* 30 */
	POWER_SUPPLY_TYPE_PMA_WIRELESS,		/* 31 */
	POWER_SUPPLY_TYPE_USB_HVDCP,		/* 32 */
	POWER_SUPPLY_TYPE_HMT_CONNECTED,	/* 33 */
	POWER_SUPPLY_TYPE_HMT_CHARGE,		/* 34 */
	POWER_SUPPLY_TYPE_WIRELESS_PACK,		/* wireless charging pack (35) */
	...
	POWER_SUPPLY_TYPE_HV_MAINS_12V,			/* 39 */
	POWER_SUPPLY_TYPE_HV_MAINS_18W,			/* Adaptive Charger (40) , AFC 2.0 18W: 9Vx1.95A*/
	POWER_SUPPLY_TYPE_PDIC,             		/* 41 */
	POWER_SUPPLY_TYPE_HV_MAINS_CHG_LIMIT,		/* 42 */
	POWER_SUPPLY_TYPE_HV_QC20,			/* 43 - ILIM 1.8A - CHG 3.0A */
	POWER_SUPPLY_TYPE_HV_QC30,			/* 44 - ILIM 3.0A - CHG 3.5A (Step Charging 4.2A -> 3.0A) */
